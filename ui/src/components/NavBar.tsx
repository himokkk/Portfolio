...
const NavBar = (props: Props) => {
    ...
    return (
        <div className="navbar prevent-select">
            <a href="/">
                <div className="navbar-button float-left" id="nameButton" onClick={home_scroll}>
                    🍊Paweł
                </div>{" "}
            </a>
            <div
                className={`navbar-button float-left ${isHome ? " color-orange" : " "}`}
                id="homeButton"
                onClick={home_scroll}
            >
                Home
            ...
            <div
                className={`navbar-button float-left ${isSkills ? " color-orange" : " "}`}
                id="skillsButton"
            ...
            <div
                className={`navbar-button float-left ${isContact ? " color-orange" : " "}`}
                id="contactButton"
